	...
	public void initDataModel() {
		cars = new LazyDataModel<Car>() {
			...
			public List<Car> load(int first, int pageSize, String sortField, SortOrder sortOrder,
				...
				py.com.isproject.rodate.infra.model.SortOrder order = null;
				if (sortOrder != null) {
					order = sortOrder.equals(SortOrder.ASCENDING)
							? py.com.isproject.rodate.infra.model.SortOrder.ASCENDING
							: sortOrder.equals(SortOrder.DESCENDING)
									? py.com.isproject.rodate.infra.model.SortOrder.DESCENDING
									: py.com.isproject.rodate.infra.model.SortOrder.UNSORTED;
				}
